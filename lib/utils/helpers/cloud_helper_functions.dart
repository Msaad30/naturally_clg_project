...
/// Returns a Widget based on the stote of the snapshot.
/// If data is still loading, it returns a CircularProgress Indicator. er Fetch and Display Products Dynamically - Sort All Pr... X
/// If on error occurs, it returns a generic eccor nessoge
/// if an error occurs, it returns a generic error message.
///Otherwise, it returns null.
